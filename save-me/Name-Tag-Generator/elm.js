...
Elm.Css.make = function (_elm) {
   ...
   var mediaQuery = F2(function (queryString,snippets) {
      return A2(media,
      _U.list([$Css$Structure.MediaQuery(queryString)]),
      snippets);
   });
   var color = function (c) {
      return A3(propertyWithWarnings,c.warnings,"color",c.value);
   };
   ...
   var borderColor4 = F4(function (c1,c2,c3,c4) {
      var value = A2($String.join,
      " ",
      _U.list([c1.value,c2.value,c3.value,c4.value]));
      var warnings = A2($Basics._op["++"],
      c1.warnings,
      A2($Basics._op["++"],
      c2.warnings,
      A2($Basics._op["++"],c3.warnings,c4.warnings)));
      return A3(propertyWithWarnings,warnings,"border-color",value);
   });
   var borderColor3 = F3(function (c1,c2,c3) {
      var value = A2($String.join,
      " ",
      _U.list([c1.value,c2.value,c3.value]));
      var warnings = A2($Basics._op["++"],
      c1.warnings,
      A2($Basics._op["++"],c2.warnings,c3.warnings));
      return A3(propertyWithWarnings,warnings,"border-color",value);
   });
   var borderColor2 = F2(function (c1,c2) {
      var value = A2($String.join,
      " ",
      _U.list([c1.value,c2.value]));
   ...
   var borderBlockEndColor = function (c) {
      return A3(propertyWithWarnings,
      c.warnings,
   ...
   var borderInlineEndColor = function (c) {
      return A3(propertyWithWarnings,
      c.warnings,
      "border-inline-end-color",
      c.value);
   };
   var borderInlineStartColor = function (c) {
      return A3(propertyWithWarnings,
      c.warnings,
   ...
   var borderBlockStartColor = function (c) {
      return A3(propertyWithWarnings,
      c.warnings,
   ...
   var textDecorationColor = function (c) {
      return A3(propertyWithWarnings,
      c.warnings,
   ...
   var hex = function (str) {
      var value = _U.eq(A3($String.slice,0,1,str),
      "#") ? str : A2($Basics._op["++"],"#",str);
